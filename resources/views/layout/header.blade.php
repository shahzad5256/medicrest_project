    ...
    <div class="main-header-left ">
        <div class="responsive-logo">
            <a href="javascript:void(0);" class="header-logo">
                <img src="" class="mobile-logo logo-1" alt="">
                ...
                <ul class="nav nav-item header-icons navbar-nav-right ms-auto">
                    ...
                    <li class="dropdown nav-item main-header-notification d-flex">
                        <a class="new nav-link" data-bs-toggle="dropdown" href="javascript:void(0);">
                            ...
                            <span class="badge bg-warning header-badge cart-counter" id="cart-counter">0</span>
                        </a>
                        <div class="dropdown-menu">
                            <div class="menu-header-content text-start border-bottom">
                                <div class="d-flex">
                                    ...
                                    <span class="badge badge-pill bg-indigo ms-auto my-auto float-end">Items (<span
                                            class="cart-counter">0</span>)</span>
                                </div>
                            </div>
                            <div class="cart-data">

                            </div>
                            <div class="dropdown-footer text-start cart-footer">
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="dropdown nav-item main-header-notification d-flex">
                        <a class="new nav-link" data-bs-toggle="dropdown" href="javascript:void(0);">
                            ...
                            </svg><span class="pulse" id="unread" style="display:none;"></span>
                        </a>
                    ...
                    <li class="dropdown main-profile-menu nav nav-item nav-link ps-lg-2">
                        <a class="new nav-link profile-user d-flex" href="" data-bs-toggle="dropdown">
                            ...
                            <img alt="" src="{{ asset('public/uploads/files/'. Auth::user()->profile_pic) }}" class="">
                            @else
                            <img alt="" src="{{asset('uploads/all/logo.png')}}" class="">
                            @endif
                        </a>
                        <div class="dropdown-menu">
                            <div class="menu-header-content p-3 border-bottom">
                                <div class="d-flex wd-100p">
                                    <div class="main-img-user">
                                        @if (Auth::user()->profile_pic != '')
                                        <img alt=""
                                            src="{{ asset('public/uploads/files/'. Auth::user()->profile_pic) }}"
                                            class="">
                                        @else
                                        <img alt="" src="{{asset('uploads/all/logo.png')}}"
                                            class="">
                                        @endif
                                    </div>
                                    <div class="ms-3 my-auto">
                                        <h6 class="tx-15 font-weight-semibold mb-0">{{ Auth::user()->first_name }}
                                            {{ Auth::user()->last_name }}</h6><span
                            ...
                            <a class="dropdown-item" href="/login"><i class="far fa-arrow-alt-circle-left"></i> Sign
                                Out</a>
                        </div>
                    </li>
                </ul>
